...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://jira-glue-result-063473290800"}, format = "csv", transformation_ctx = "datasink2"]
## @return: datasink2
## @inputs: [frame = applymapping1]
datasink2 = glueContext.write_dynamic_frame.from_options(frame = applymapping1, connection_type = "s3", connection_options = {"path": "s3://jira-glue-result-063473290800"}, format = "csv", transformation_ctx = "datasink2")
job.commit()